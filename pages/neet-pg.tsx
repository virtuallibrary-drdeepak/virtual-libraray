        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start lg:gap-12">
          ...
          <div className="mx-auto grid w-full max-w-3xl gap-4 sm:mt-2 md:grid-cols-2 lg:mx-0 lg:max-w-none">
            {AUDIENCES.map((audience, index) => (
              <article
                key={audience.title}
                className={`${audience.tone} group flex min-h-[76px] items-center gap-4 rounded-[22px] border border-white/70 px-4 py-4 shadow-[0_16px_38px_rgba(59,43,101,0.08)] ring-1 ring-[#e7ddfb]/70 transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_24px_58px_rgba(86,52,180,0.14)] sm:min-h-[92px] sm:rounded-[24px] sm:px-5 ${index === AUDIENCES.length - 1 ? 'md:col-span-2' : ''}`}
              >
                <span
